...
/*
 * 판매 중단
 *  잠깐 쉴 때든, 올해 판매를 완전히 마쳤을 때든 이 스위치 하나로
 *  주문을 막을 수 있습니다.
 *  active 를 true 로 두면 주문 계산기·주문서 칸이 전부 숨겨지고
 *  대신 아래 안내문이 뜹니다. 다시 주문을 받으실 때는
 *  active 를 false 로 바꾸기만 하면 원래대로 돌아옵니다.
 *  icon 은 이모지 하나면 됩니다 (예: 일시중단 ⏸️ · 시즌 마감 🙏).
 */
const SALE_PAUSE = {
  active: true,
  icon: '🙏',
  title: '올해 판매가 모두 끝났습니다',
  // 줄바꿈은 그대로 문단이 나뉘어 표시됩니다.
  message:
    '올해 복숭아 판매는 모두 마무리되었습니다.\n' +
    '한 해 동안 저희 복숭아를 찾아주셔서 감사했습니다.\n' +
    '내년에 다시 맛있는 복숭아로 찾아뵙겠습니다.',
};
